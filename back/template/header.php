...
<div id="main">
	<div id="header">
		<a href="index.html" class="logo"><img src="../statics/image/logo.png" alt="" /></a>
		...
		<?	}	else	{	?>
			...
			<li<? if ($page=='config') echo ' class="active"';?>><span><span><? if ($page=='config'){ ?>تنظیمات<? } else { ?><a href="config.php">تنظیمات</a><? } ?></span></span></li>
...
<?		} else {	?>
			...
			<ul class="nav">
				...
				<li><a href="config.php">تنظیمات</a></li>
